{
  ...
  inputs = {
    ...
    usdaeco-wall.url = "github:criad-com/usdaeco-wall?ref=v0.2.6";
    usdaeco-wall.flake = false;
    usdaeco-pipe.url = "github:criad-com/usdaeco-pipe?ref=v0.2.6";
    usdaeco-pipe.flake = false;
    usdaeco-cctv.url = "github:criad-com/usdaeco-cctv?ref=v0.5.7";
    usdaeco-cctv.flake = false;
    usdaeco-clash.url = "github:criad-com/usdaeco-clash?ref=v0.2.4";
    usdaeco-clash.flake = false;
    usdaeco-plan.url = "github:criad-com/usdaeco-plan?ref=v0.1.5";
    usdaeco-plan.flake = false;
    usdaeco-repeat.url = "github:criad-com/usdaeco-repeat?ref=v0.2.1";
    usdaeco-repeat.flake = false;
    usdaeco-compliance.url = "github:criad-com/usdaeco-compliance?ref=v0.2.1";
    usdaeco-compliance.flake = false;
    usdaeco-solid.url = "github:criad-com/usdaeco-solid?ref=v0.1.6";
    ...
    usdaeco-datacentre.url = "github:criad-com/usdaeco-datacentre?ref=v0.6.0";
    usdaeco-datacentre.flake = false;
    usdaeco-scenarios.url = "github:criad-com/usdaeco-scenarios?ref=v0.9.2";
